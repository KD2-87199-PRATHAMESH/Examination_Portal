...
function FacultyHome() {
    ...
    return (
        <div>
            ...
            {/* Pass subjectId as state to AddQuiz page */}
            <Link to="/addQuiz" state={{ subjectId }} className="mt-3 btn btn-success">
                Add Quiz
            </Link>

            {quizes.length === 0 && (
                <div className="mt-3">
                    <h6>Please add quiz by clicking on Add Quiz button</h6>
                </div>
            )}
